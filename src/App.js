...
function App() {
  return (
    <div className="App">
      ...
      <Hello></Hello> 
<Wish/> */}
{/* <Greeting name="sriram" mail="vinaysriram@gmail.com">
  </Greeting>
  <img src={logo} style={{width:"100px"}} />
 <Greeting name="sriram" mail="sriram@gmail.com">
   <p>hi</p>
 <p>Hello Da</p>
 </Greeting>
  <h2>Welcome</h2> */}
   ...
   {/* <h1>
    ...
    <Welcome name="sriram" college="svecw"></Welcome> */} 
  <BrowserRouter>
      ...
      <div className="row justify-content-center">
        {
          ...
          <a href="tel:9177186267">{value.basic.phone}</a><br></br>
          <a href="mailto:vinaysriramvsr007@gmail.com">{value.basic.email}</a><br></br>
